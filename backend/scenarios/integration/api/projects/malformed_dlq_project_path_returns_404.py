"""Malformed DLQ project identifiers return 404 instead of a server error."""
...
class Scenario(vedro.Scenario):
    subject = "malformed DLQ project path returns 404"
    ...
    def when_dlq_is_requested_for_a_non_numeric_project(self):
        self.response = self.client.get(
            "/api/projects/not-a-project/dlq",
