"""Test: canceled pipeline webhook marks as failed when no newer pipeline exists."""

import vedro
from scenarios.fakes import FakeGitLabClient, create_pipeline
...
class Scenario(vedro.Scenario):
    subject = "canceled pipeline marks as failed when no newer pipeline exists"
