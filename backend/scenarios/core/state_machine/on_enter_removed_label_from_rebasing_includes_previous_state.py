"""Test on_enter_removed from rebasing state includes previous_state in notify."""
...
class Scenario(vedro.Scenario):
    subject = "on_enter_removed from rebasing includes previous_state=rebasing"
    ...
    def then_notifier_should_include_previous_state_rebasing(self):
        call_args = self.notifier.notify_calls[0]
        assert call_args["status"] == "removed_label"
        assert call_args["previous_state"] == "rebasing"
