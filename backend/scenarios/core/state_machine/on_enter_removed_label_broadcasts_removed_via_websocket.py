"""Regression: on_enter_removed with label_removed broadcasts removed status via WebSocket."""
...
class Scenario(vedro.Scenario):
    subject = "on_enter_removed with label_removed broadcasts removed via WebSocket"
    ...
    def then_websocket_broadcasts_removed_status(self):
        ...
        assert completed_broadcasts[0]["status"] == "removed"
