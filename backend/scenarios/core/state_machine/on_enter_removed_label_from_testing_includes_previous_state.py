"""Test on_enter_removed from testing state includes previous_state in notify."""
...
class Scenario(vedro.Scenario):
    subject = "on_enter_removed from testing includes previous_state=testing"
    ...
    def then_notifier_should_include_previous_state_testing(self):
        call_args = self.notifier.notify_calls[0]
        assert call_args["status"] == "removed_label"
        assert call_args["previous_state"] == "testing"
