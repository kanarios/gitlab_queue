"""Test check_needs_rebase returns READY for merge_status='checking'."""
...
class Scenario(vedro.Scenario):
    subject = "check_needs_rebase returns READY for merge_status='checking'"

    def given_handler_with_checking_mr(self):
        mr = MockMergeRequest(merge_status="checking", has_conflicts=False)
