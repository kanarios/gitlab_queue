"""Test _check_and_handle_rebase_during_testing preserves retried_jobs on API error.

When handle_rebase_if_needed raises GitLabAPIError, the handler
...
class Scenario(vedro.Scenario):
    subject = "rebase api error preserves existing retried_jobs in trigger_pipeline_failed"
